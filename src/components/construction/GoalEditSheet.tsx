    ...
    <>
      {isMobile ? (
        <DialogHeader>
          ...
          <DialogDescription>Modifica los datos de tu meta.</DialogDescription>
        </DialogHeader>
      ) : (
        <SheetHeader>
  ...
  if (isMobile) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="w-[calc(100vw-1.5rem)] max-w-[420px] max-h-[90vh] overflow-y-auto p-4">
          {formContent}
        </DialogContent>
      </Dialog>
    );
