      ...
      <div className="sticky top-14 lg:top-0 z-10 bg-background/95 backdrop-blur-sm pb-3 -mx-1 px-1 pt-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">{account.currency} · Saldo: {isLiab && account.current_balance !== 0 ? "-" : ""}{fmt(Math.abs(account.current_balance), account.currency)}</p>
          </div>
        </div>
      </div>
